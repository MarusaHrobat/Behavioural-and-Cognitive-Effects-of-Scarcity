...
length(which(questionnaire$Q2 == "1"))  
length(which(questionnaire$Q2 == "0")) 
length(which(questionnaire$Q2 == "2")) 

length(which(questionnaire$Q3 == "0"))
length(which(questionnaire$Q3 == "1"))
length(which(questionnaire$Q3 == "2")) 
length(which(questionnaire$Q3 == "3")) 
length(which(questionnaire$Q3 == "4")) 
length(which(questionnaire$Q3 == "5")) 

length(which(questionnaire$Q4 == "0")) 
length(which(questionnaire$Q4 == "1")) 
length(which(questionnaire$Q4 == "2")) 

length(which(questionnaire$Q5 == "0"))
length(which(questionnaire$Q5 == "1"))
length(which(questionnaire$Q5 == "2")) 

mean_english = mean(questionnaire$Q6)
mean_english


length(which(questionnaire$Q7 == "2")) 
length(which(questionnaire$Q7 == "3")) 
length(which(questionnaire$Q7 == "4")) 


length(which(questionnaire$Q8 == "0"))
length(which(questionnaire$Q8 == "1")) 
length(which(questionnaire$Q8 == "2")) 
length(which(questionnaire$Q8 == "3")) 
length(which(questionnaire$Q8 == "4"))
...
CookD(perletter.interaction) 

#comparisons
anova(perletter.between, perletter.null)
anova(perletter.within, perletter.null) 
anova(perletter.both, perletter.between) 
...
anova(rt.within, rt.both) 
anova(rt.between, rt.both) 
anova(rt.both, rt.interaction) 
...
anova(acc.within, acc.both) 
anova(acc.between, acc.both) 
anova(acc.both, acc.interaction) 
